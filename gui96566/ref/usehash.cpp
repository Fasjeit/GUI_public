...
extern int keypair(unsigned char sk[SECRETKEY_BYTES], unsigned long long *sklen, unsigned char pk[PUBLICKEY_BYTES],
    ...
    const unsigned char *pk)
{
  ...
  for (i = SIGNATURE_BYTES; i < smlen; ++i)
    m[i - SIGNATURE_BYTES] = sm[i];
