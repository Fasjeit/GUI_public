...
class Program
{
    ...
    public static class Externc
    {
        ...
        [DllImport(Externc.Libqa, EntryPoint = "hfev", CallingConvention = CallingConvention.StdCall)]
        internal static extern int hfev(
                    byte[] sk,
                    long sklen,
                    byte[] s,
                    long slen,
        ...
        // const unsigned long long sklen,
